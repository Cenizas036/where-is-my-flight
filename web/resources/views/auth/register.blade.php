@extends('layouts.app')
@section('title', 'Join — Where Is My Flight')
...
<div class="max-w-md mx-auto pt-12">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-400 text-sm mt-1">Join the community — help other passengers find their gates</p>
    </div>
    ...
    <div class="glass-card rounded-2xl p-8">
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div>
                <label for="display_name" class="text-sm text-gray-400 mb-2 block">Display Name</label>
            ...
            <div>
                <label for="password_confirmation" class="text-sm text-gray-400 mb-2 block">Confirm Password</label>
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
            ...
            <a href="{{ route('login') }}" class="text-wimf-400 hover:text-wimf-300 font-medium transition-colors">
                Sign in
            </a>
        </p>
    </div>

    <p class="text-center text-xs text-gray-600 mt-6 max-w-sm mx-auto leading-relaxed">
        By joining, you contribute to the community — your gate updates help other passengers navigate airports in real time.
    </p>
</div>
@endsection
