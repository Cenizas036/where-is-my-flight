...
class OpenSkyService
{
        ...
        return Cache::remember('opensky:all', 120, function () {
            try {
                ...
                if ($response->status() === 429) {
                    ...
                    Cache::put('opensky:rate_limited', true, 600); // 10 min backoff
                    return $this->getDemoFlights();
                }
    ...
    {
        // If rate-limited, filter demo flights by bounding box
        if (Cache::has('opensky:rate_limited')) {
     ...
     * These are based on common real flights with realistic coordinates.
     */
    private function getDemoFlights(): array
    {
        return [
            ...
            // International flights near DEL
